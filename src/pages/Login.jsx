    ...
    <div className="w-full max-w-md mx-auto px-4 md:px-6 animate-fade-in">
      <div className="glass-panel rounded-xl p-6 md:p-8 lg:p-10 shadow-xl">
        ...
        <div className="flex justify-center mb-5 md:mb-6">
          <div className="w-14 h-14 md:w-16 md:h-16 rounded-xl bg-gradient-to-br from-indigo-600 to-purple-600 flex items-center justify-center shadow-lg">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                type="email"
                {...register('email')}
                className={`w-full rounded-xl border-0 bg-gray-50 pl-10 md:pl-12 pr-4 py-3 md:py-3.5 text-sm md:text-base text-gray-900 font-medium placeholder-gray-400 focus:ring-1 focus:ring-indigo-500 focus:bg-white transition-colors duration-200 outline-none ${errors.email ? 'ring-1 ring-red-500' : ''}`}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                {...register('password')}
                className={`w-full rounded-xl border-0 bg-gray-50 pl-10 md:pl-12 pr-11 md:pr-12 py-3 md:py-3.5 text-sm md:text-base text-gray-900 font-medium placeholder-gray-400 focus:ring-1 focus:ring-indigo-500 focus:bg-white transition-colors duration-200 outline-none ${errors.password ? 'ring-1 ring-red-500' : ''}`}
                placeholder="••••••••"
              />
              <button
                type="button"

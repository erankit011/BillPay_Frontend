          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 opacity-75">
              <div>
                ...
                <input type="text" className="mt-1 block w-full rounded-xl border-gray-300 border p-2.5 bg-gray-50 text-gray-500 cursor-not-allowed" value={user?.shopName || ''} readOnly disabled />
              ...
              <div>
                ...
                <input type="text" className="mt-1 block w-full rounded-xl border-gray-300 border p-2.5 bg-gray-50 text-gray-500 cursor-not-allowed" value={user?.phone || ''} readOnly disabled />

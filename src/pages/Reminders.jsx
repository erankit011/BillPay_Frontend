          ...
          <div className="lg:col-span-2 space-y-4 md:space-y-5">
            ...
            <div className="relative w-full">
              ...
              <input
                ...
                className="block w-full pl-12 pr-4 py-2.5 md:py-3 bg-white border border-gray-200 rounded-xl focus:ring-1 focus:ring-[#093C5D] focus:border-[#093C5D] text-xs md:text-sm font-medium transition-colors duration-200"
              />
            </div>

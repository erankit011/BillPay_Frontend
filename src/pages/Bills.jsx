    ...
    <div className="w-full space-y-6 md:space-y-8 lg:space-y-10 xl:space-y-12">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4">
        ...
        <button
          ...
          className="hidden md:flex cursor-pointer bg-[#093C5D] hover:bg-[#082a42] text-white px-4 sm:px-5 md:px-6 py-2 md:py-2.5 rounded-lg items-center whitespace-nowrap shrink-0 font-semibold text-xs md:text-sm w-full sm:w-auto justify-center active:scale-95 transition-all"
        >
      ...
      <button
          onClick={() => setIsModalOpen(true)}
          className="md:hidden fixed bottom-6 sm:bottom-8 right-6 sm:right-8 z-50 bg-[#093C5D] hover:bg-[#082a42] text-white px-4 sm:px-5 py-2.5 sm:py-3 rounded-lg cursor-pointer flex items-center justify-center gap-1.5 active:scale-95 transition-all duration-200"

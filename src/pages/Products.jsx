    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">{t('Manage your shop items and stock levels')}</p>
        </div>
        <button 
        ...
        {isLoading ? (
          ...
          <div className="divide-y divide-gray-100">
            {filteredProducts.map((product, index) => (
              <div 
                key={product._id} 
                className="p-4 hover:bg-gray-50 transition-all duration-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 animate-fade-in"
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button 
                    ...
                    className="text-gray-600 hover:text-red-600 bg-gray-100 hover:bg-red-50 p-2 rounded-lg transition-colors"
                    title={t("Delete")}
                  >
